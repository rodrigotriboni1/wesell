    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(ClienteActivity.this, "Não foi possível carregar os clientes.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(this, recyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(ClienteActivity.this, AddVendaActivity.class);
        ...
        builder.setPositiveButton("Salvar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (!TextUtils.isEmpty(nome)) {
                    ...
                    Toast.makeText(ClienteActivity.this, "Preencha o nome do cliente.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void excluirCliente(final int position) {
        ...
        builder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Toast.makeText(ClienteActivity.this, "Cliente excluído com sucesso!", Toast.LENGTH_SHORT).show();
            }
        });
